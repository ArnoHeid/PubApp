...
/**
 * Test class checks whether search works for set parameters
 * 
 * @author caro
 *
 */
public class ResponseHandlerTest {
	...
	@Test
	/**
	 * Tests if Overpass Api with works, Bounding Box considers first two
	 * coordinates in List returned FeatureCollection is control parameter
	 */
	...
	@Test
	/**
	 * Test if Google Places works, radius field in config file must be set to
	 * 1000 returned FeatureCollection is control parameter
	 */
